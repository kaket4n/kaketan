module ApplicationHelper
  ...
  def twitter_share_button(url:nil, text:nil)
    "<a href='https://twitter.com/share' class='twitter-share-button' data-url='#{url}' data-text='#{text&.truncate(70)}｜KAKETAN.COM' data-hashtags='KAKETANCOM'>Tweet</a> <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>".html_safe
  end
